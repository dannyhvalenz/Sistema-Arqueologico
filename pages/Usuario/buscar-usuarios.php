 ...
 while($row = mysqli_fetch_array($result))
 {
  ...
  <tbody>
   <tr>
    ...
    <td><a href="../../pages/Admin/actualizar-usuario.php?idUsuario='.$row["idUsuario"].'"
        class="btn btn-warning glyphicon glyphicon-pencil" data-toggle="modal" id="editar"></a>
    </td>
    <td><a href="../Sistema Arqueologico/functions/Analisis/eliminarUsuario.php?idUsuario='.$row["idUsuario"].'"
