...
<body>
    ...
    <div class="container" style="min-height:72vh">
        ...
        <form class="form-horizontal validate-form needs-validation" id="formDatos" method="GET"
							...
							if (count($carpeta) > 2){
								...
								while (($archivo = $dirint->read()) !== false){
									if( $archivo != "." && $archivo != "..") {
										...
										echo '<img src="'.$directorio."/".$archivo.'" class="img-rounded" width="225" height="265">'."\n";
    ...
    $(function(){
            $("#formDatos").on("submit", function(e){
                ...
                $.ajax({
                    url: "../../functions/Pastas/actualizarAnalisis.php",
                    type: "post",
                    data: formDat,
                    cache: false,
                    contentType: false,
                    ...
                    success: function(result){
                        ...
                        if (result == "exito") {
							...
							location.href="actualizar-pastas.php?analisisFallido=true&reason=errorconexion&IdAnalisisPastas=<?php echo $IdAnalisisPastas?>"
                        } else if (result == "existe") {
							location.href="actualizar-pastas.php?analisisFallido=true&reason=existe&IdAnalisisPastas=<?php echo $IdAnalisisPastas?>"
                        }
                    }
                });
            });
