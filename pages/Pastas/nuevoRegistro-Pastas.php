        ...
        <form class="form-horizontal validate-form" action="../../functions/Pastas/creaAnalisis.php" method="POST" enctype="multipart/form-data"
            ...
            <div>
                <div class="row align-items-start">
                    ...
                    <div class="col-4 validate-input" data-validate="Ingresa el sitio">
            ...
            <div class="" style="margin-top: 25px; margin-left: 90px;">
...
<!--SCRIPTS-->
    <!-- Dropzone -->
    <link rel="stylesheet" href="../../other/dropzone/dropzone.js">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/4.2.0/min/dropzone.min.js"></script>
    ...
    <script src="../../other/sweetalert2/sweetalert2.all.js"></script>

    <!-- jQuery 3 -->
    <script src="../../other/jquery/dist/jquery-3.4.1.min.js"></script>
