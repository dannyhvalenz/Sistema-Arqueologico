...
<body>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Análisis de Pastas Fallido</h4>
   ...
   <div class="container text-center">
    ...
    <script>
    function agregarImagenes(idAnalisis){//esta función llama las imagenes de un registro
        $('#imagenes').html("");
        $.ajax({
            url: "archivos.php",
            method: "POST",
            ...
            success: function(archi){
                ...
                for(var i=2; i<jsonparse.length;i++){
                    if( jsonparse[i] != "." && jsonparse[i] != "..") {
                        var ruta = 'imagenes/'+idAnalisis+'/'+jsonparse[i];
                        if (primera == true){
                            cadena = '<div class="item active"> <img class="img-responsive" src="'+ruta+'" ></div>';
