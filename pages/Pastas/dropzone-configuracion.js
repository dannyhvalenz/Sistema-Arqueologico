Dropzone.options.configuracionDropzone = {    
    url: null,//se especifica cuando el form no tiene el artributo action, por de fault toma la url del action en el formulario
    ...
    filesizeBase: 1000,
    maxFiles: 10,//si no es nulo, define cuántos archivos se cargaRAN. Si se excede, se llamará el EVENTO maxfilesexceeded.
