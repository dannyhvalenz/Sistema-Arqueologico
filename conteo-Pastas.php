...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="conteo-Pastas.php">Conteo de pastas <span class="sr-only">(current)</span></a>
                </li>
            </ul>
    ...
    <div class="" style="margin:15px;margin-left:30px">
        <div class="row">
            ...
            <input type="text" name="search_text" id="search_text" placeholder="Buscar registro" class="form-control" style="width:300px; margin-right:10px"/> 
